...
//         <button aria-label="Log in with Google" className="icon rounded-md p-3 bg-transparent ml-2">
...
// </svg>
//         </button>
//         <button aria-label="Log in with Twitter" className="icon rounded-md p-3 bg-transparent ml-2">
// <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="h-5 w-5 fill-current">
...
// </svg>
//         </button>
//         <button aria-label="Log in with GitHub" className="icon rounded-md p-3 bg-transparent ml-2">
//           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="h-5 w-5 fill-current">
...
//         </button>
//       </div>
//       <p className="signup text-center text-xs text-gray-400 mt-4">Don't have an account?
//         <a href="#" className="text-gray-200 ml-1 hover:underline hover:text-purple-300">Sign up</a>
//       </p>
//     </div>
//   );
// };
...
const LoginForm = ({ onSubmit }) => {
  ...
  // Handler for sign up redirection
  ...
  return (
    <div className="form-container w-80 rounded-lg bg-gray-900 p-8 text-gray-200">
      ...
      <p className="signup text-center text-xs text-gray-400 mt-4">
        ...
        <a href="#" onClick={handleSignUpClick} className="text-gray-200 ml-1 hover:underline hover:text-purple-300">Sign up</a>
      </p>
    </div>
  );
};
